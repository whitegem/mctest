...
<table dir='ltr' border='1' cellspacing='0' cellpadding='1'>
	<tr><th align='left' bgcolor='#f57900' colspan="10" ><span style='background-color: #cc0000; color: #fce94f; font-size: x-large;'>( ! )</span> [{{$level}}]{{$errmsg}} at {{$errfile}}, line {{$errline}}</th></tr>
	...
	<tr><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{$cnt - $i}}</td><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{Error::getFunctionName($stack[$i])}}</td><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{Error::getFunctionLocation($stack[$i])}}</td></tr>
	{{/for}}
</table>
</div>
<hr size="1" />
